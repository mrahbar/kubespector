...
func New(address string, config *Config, lp func(msg string, a ...interface{})) (result *Comm, err error) {
	logPrinter = lp
	...
	go func() {
		...
		if err != nil {
			...
			case *ssh.ExitError:
                ...
                logPrinter("Remote command '%s' exited with '%d': %s", cmd.Command, exitStatus, err)
